...
# setopt append_history          # append to history file (share_history handles this)
...
# setopt inc_append_history      # (share_history handles this)
unsetopt hist_beep             # don't beep when attempting to access a missing history entry
setopt share_history           # share history between all sessions (includes inc_append + import)
